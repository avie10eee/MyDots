...
alias upgrade='sudo dnf upgrade && nix-env -u' # upgrades the system and nix
alias wall='./.autobg.sh' # runs the wallpaper script
alias theme='bash .tswitch.sh' # runs the terminal theme script
